...
export function renderRows(
  ...
  const labels = {
    ...
    spina: u =>
      `${u.spina.toLocaleString('id-ID')} Spina`
  };
  ...
  el.innerHTML = sorted.length
    ...
    ? sorted.map((u, i) => `
      ...
      <div class="rankRow">
        ...
        <div>
          ...
          <div class="meta">
            Rank ${escapeHtml(u.rank)}
            •
            ${u.exp.toLocaleString('id-ID')} EXP
          </div>
    ...
    : `
      <div class="empty">
        Belum ada data user dari Firebase.
      </div>
    `;
}
